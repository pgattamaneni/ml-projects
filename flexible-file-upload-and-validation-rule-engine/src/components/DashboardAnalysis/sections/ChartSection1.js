...
// MDBListGroup, MDBListGroupItem, MDBBadge, MDBIcon
...
class ChartSection1 extends Component {
    render(){
        ...
        const dataPie = {
            labels: ['Type', 'Delimeter', 'Line Breaks', 'Blank Rows', 'Wrong Type', 'Extra Column', 'Warnings'],
            datasets: [
            {
        ...
        return (
            <MDBRow className="mb-4">
                ...
                <MDBCol md="4" className="mb-4">
                    <MDBCard className="mb-4">
                        <MDBCardHeader>Error Chart</MDBCardHeader>
                        <MDBCardBody>
