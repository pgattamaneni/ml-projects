...
const AdminCardSection2 = () => {
  return (
    ...
    //           <h4 className="text-white text-2xl my-2"><strong>$2000</strong></h4>
    //         </MDBCardBody>
    ...
    //         </div>
    //         <MDBCardBody>
    //           <p className="text-gray-200">Better than last week (25%)</p>
    //         </MDBCardBody>
    //       </MDBCard>
    //     </MDBCol>
    //     <MDBCol xl="3" md="6" className="mb-3">
    ...
    //           <h4 className="text-white text-2xl my-2"><strong>200</strong></h4>
    //         </MDBCardBody>
    //         <div className="progress">
    //           <div aria-valuemax="100" aria-valuemin="0" aria-valuenow="25" className="progress-bar bg grey darken-3" role="progressbar" style={{width: "25%"}}></div>
    //         </div>
    //         <MDBCardBody>
    //           <p className="text-gray-200">Worse than last week (25%)</p>
    //         </MDBCardBody>
    //       </MDBCard>
    //     </MDBCol>
    //     <MDBCol xl="3" md="6" className="mb-3">
    ...
    //           <h4 className="text-white text-2xl my-2"><strong>20000</strong></h4>
    //         </MDBCardBody>
    //         <div className="progress">
    ...
    //         </div>
    //         <MDBCardBody>
    //           <p className="text-gray-200">Better than last week (75%)</p>
    //         </MDBCardBody>
    //       </MDBCard>
    //     </MDBCol>
    //     <MDBCol xl="3" md="6" className="mb-3">
